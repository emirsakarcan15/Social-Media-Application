...
function PhotosInProfile() {
  ...
  React.useEffect(() => {
    const getPhotos = async () => {
      const responseGetPhotos = await fetch("http://localhost:3000/api/social/profile/photos", {
        method: "GET",
        headers: {
    ...
    <div style={{width:"750px"}}>
      ...
      >
        ...
        <Card sx={{ width: 500, height: 500, display: 'flex', flexDirection: 'column', alignItems: 'center', objectFit: 'cover' }}>
          <div style={{ display: 'flex', flexDirection: "row", alignItems: "center" }}>
            ...
            <Typography id="modal-modal-title" variant="h6" component="h2" sx={{ margin: 2, marginRight: 40 }}>johndoe_</Typography>
          </div>
      <CardMedia
        component="img"
        alt="green iguana"
      ...
      <CardContent style={{ width: '100%' }} >
        ...
        <div style={{ display: 'flex', flexDirection: 'row', marginTop: 2, marginLeft: 15, alignItems: "center" }}>
          <Typography gutterBottom component="div" sx={{ marginTop: 1, color: 'black', fontSize: 17, display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
...
export default PhotosInProfile